  ...
  return (
    <section className="bg-black text-white mx-auto px-4 py-8">
          <div className="max-w-6xl mx-auto">
              <h1 className="text-3xl font-semibold text-center mb-6 mt-1">Website Terms of Use</h1>
              ...
              <div className="mt-8 space-y-6">
                  ...
                  <section>
                      ...
                      <p className="text-white">
                          All content on this website (including text, images, graphics, and logos) is owned by or licensed to  Studio 35.
